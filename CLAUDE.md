...
**`CONTRIBUTING.md` is the working agreement** — code style, tests, linting, commits, pull
requests and the trade-log gate. This section is only the conventions specific to the domain.
