...
Net P&L and drawdown reproduce [#261]'s figures exactly in four of the five years; the profit factors sit about 0.01 above its, which is a difference between two computations of the same trades rather than between two sets of trades.
