...
| `§M19.1`                                                                                              | [M19.1 — compression as a condition, before it is an archetype](m19-1-compression-condition.md)                                                                    | DeadCatBounce, ElasticBand, EmaCrossover, InsideBar, InsideBarTrailing, OpeningRange, PullBackAndGo | 1, 2       | `negative`    | [#51]                          |
| `§M19.2`                                                                                              | [M19.2 — SqueezeBreakout: a break of the compressed window, one side at a time](m19-2-squeeze-breakout-spec.md)                                                    | SqueezeBreakout                                                                                     | --         | `spec`        | [#51]                          |
| `§M19.3`                                                                                              | [M19.3 — SqueezeBreakout swept: the squeeze's depth is nearly inert, and one short pocket clears the null on 31 trades](m19-3-squeeze-breakout-swept.md)           | SqueezeBreakout                                                                                     | 1, 2, 3    | `mixed`       | [#51]                          |
...
| `§M27`                                                                                                | [M27 — the registry-wide campaign: every archetype, every axis](m27-registry-campaign.md)                                                                          | DeadCatBounce, ElasticBand, EmaCrossover, InsideBar, InsideBarTrailing, PullBackAndGo               | 1, 2, 3, 4 | `mixed`       | [#195], [#196]                 |
| `§M27.3`                                                                                              | [M27.3 — InsideBar's bracket, crossed at last](m27-3-insidebar-bracket.md)                                                                                         | InsideBar                                                                                           | 2, 3, 4    | `negative`    | [#198]                         |
| `§M27.4`                                                                                              | [M27.4 — the sixteen strata that were never held out](m27-4-strata-held-out.md)                                                                                    | DeadCatBounce, ElasticBand, EmaCrossover, InsideBar, InsideBarTrailing, PullBackAndGo               | 2          | `mixed`       | [#199]                         |
| `§M27.5`                                                                                              | [M27.5 — the regime threshold, calibrated rather than swept blind](m27-5-regime-threshold.md)                                                                      | DeadCatBounce, ElasticBand, EmaCrossover, InsideBar, InsideBarTrailing, PullBackAndGo               | --         | `calibration` | [#200]                         |
| `§M27.6`                                                                                              | [M27.6 — walk-forward and Monte Carlo, wired into the campaign](m27-6-walkforward-montecarlo.md)                                                                   | --                                                                                                  | 4          | `tooling`     | [#203]                         |
| `§M27.7`                                                                                              | [M27.7 — time of day: swept, never read, and the artefact is in the wrong phase](m27-7-time-of-day.md)                                                             | DeadCatBounce, ElasticBand, EmaCrossover, InsideBar, InsideBarTrailing, OpeningRange, PullBackAndGo | 3          | `mixed`       | [#205]                         |
| `§M27.8`                                                                                              | [M27.8 — volume: one form, one cut, and the answer is the cut's](m27-8-volume.md)                                                                                  | DeadCatBounce, ElasticBand, EmaCrossover, InsideBar, InsideBarTrailing, OpeningRange, PullBackAndGo | 2, 3       | `mixed`       | [#206]                         |
...
| `§M28.9`                                                                                              | [M28.9 — the survivor, read for tradeability rather than for rank](m28-9-survivor-tradeability.md)                                                                 | DeadCatBounce, ElasticBand, EmaCrossover, InsideBar, InsideBarTrailing, OpeningRange, PullBackAndGo | 4          | `mixed`       | [#261], [#262], [#263], [#264] |
...
| `§M28.12`                                                                                             | [M28.12 — the bracket decomposition, read across the registry](m28-12-bracket-decomposition.md)                                                                    | DeadCatBounce, ElasticBand, EmaCrossover, InsideBar, InsideBarTrailing, OpeningRange, PullBackAndGo | --         | `mixed`       | [#264]                         |
| `§M28.13`                                                                                             | [M28.13 — the registry read through an account, and the assumption that turned out to be a parameter](m28-13-account-read.md)                                      | DeadCatBounce, ElasticBand, EmaCrossover, InsideBar, InsideBarTrailing, OpeningRange, PullBackAndGo | --         | `mixed`       | [#75]                          |
| `§M28.14`                                                                                             | [M28.14 — every stratum against its unfiltered twin, and the cell that survives it](m28-14-stratum-cross-read.md)                                                  | DeadCatBounce, ElasticBand, EmaCrossover, InsideBar, InsideBarTrailing, OpeningRange, PullBackAndGo | 3          | `mixed`       | [#285]                         |
...
| `§M29`                                                                                                | [M29 — the maximum hold time: the one axis whose best value is off on every archetype](m29-maximum-hold-time.md)                                                   | DeadCatBounce, ElasticBand, EmaCrossover, InsideBar, InsideBarTrailing, OpeningRange, PullBackAndGo | 1, 2       | `negative`    | [#292]                         |
| `§M30`                                                                                                | [M30 — volume and regime re-cut across the registry, and what the raw pair was reporting](m30-volume-regime-recut.md)                                              | DeadCatBounce, ElasticBand, EmaCrossover, InsideBar, InsideBarTrailing, OpeningRange, PullBackAndGo | 2          | `mixed`       | [#289]                         |
...
| `§M32`                                                                                                | [M32 — the two volume windows swept, and why a window is a cell rather than an axis](m32-volume-windows.md)                                                        | DeadCatBounce, ElasticBand, EmaCrossover, InsideBar, InsideBarTrailing, OpeningRange, PullBackAndGo | 2          | `mixed`       | [#299]                         |
...
| `§M45`                                                                                                | [M45 — InsideBarTrailing sized per signal: tiering fails, a confluence size clears its null, and position size read through the account](m45-ibt-sizing-result.md) | InsideBarTrailing                                                                                   | 2, 3       | `mixed`       | [#295], [#353]                 |
...
| `§ "M45 — pre-registration: InsideBarTrailing's position size, tiered scale-out and confluence size"` | [M45 — pre-registration: InsideBarTrailing's position size, tiered scale-out and confluence size](m45-ibt-sizing-preregistration.md)                               | InsideBarTrailing                                                                                   | 2, 3       | `spec`        | [#295], [#353]                 |
...
**[M36 — EmaPullback's volume dimension re-cut, and the first raw cell whose direction transfers](m36-ema-pullback-volume-recut.md)**
...
**[M39 — EmaPullback's confirmation entry: it wins the selection window and not the holdout](m39-ema-pullback-confirmation-entry.md)**
...
**[M45 — InsideBarTrailing sized per signal: tiering fails, a confluence size clears its null, and position size read through the account](m45-ibt-sizing-result.md)**
...
**[Do the shortlists travel? NQ and MNQ configurations run on ES, MES, GC and MGC](cross-root-transfer.md)**
