...
| `§M19.1`                                           | [M19.1 — compression as a condition, before it is an archetype](m19-1-compression-condition.md)                                           | all but EmaPullback                                                                   | 1, 2       | `negative`    | [#51]                          |
...
| `§M27.7`                                           | [M27.7 — time of day: swept, never read, and the artefact is in the wrong phase](m27-7-time-of-day.md)                                    | all but EmaPullback                                                                   | 3          | `mixed`       | [#205]                         |
| `§M27.8`                                           | [M27.8 — volume: one form, one cut, and the answer is the cut's](m27-8-volume.md)                                                         | all but EmaPullback                                                                   | 2, 3       | `mixed`       | [#206]                         |
...
| `§M28.9`                                           | [M28.9 — the survivor, read for tradeability rather than for rank](m28-9-survivor-tradeability.md)                                        | all but EmaPullback                                                                   | 4          | `mixed`       | [#261], [#262], [#263], [#264] |
...
| `§M28.12`                                          | [M28.12 — the bracket decomposition, read across the registry](m28-12-bracket-decomposition.md)                                           | all but EmaPullback                                                                   | --         | `mixed`       | [#264]                         |
| `§M28.13`                                          | [M28.13 — the registry read through an account, and the assumption that turned out to be a parameter](m28-13-account-read.md)             | all but EmaPullback                                                                   | --         | `mixed`       | [#75]                          |
| `§M28.14`                                          | [M28.14 — every stratum against its unfiltered twin, and the cell that survives it](m28-14-stratum-cross-read.md)                         | all but EmaPullback                                                                   | 3          | `mixed`       | [#285]                         |
...
| `§M29`                                             | [M29 — the maximum hold time: the one axis whose best value is off on every archetype](m29-maximum-hold-time.md)                          | all but EmaPullback                                                                   | 1, 2       | `negative`    | [#292]                         |
| `§M30`                                             | [M30 — volume and regime re-cut across the registry, and what the raw pair was reporting](m30-volume-regime-recut.md)                     | all but EmaPullback                                                                   | 2          | `mixed`       | [#289]                         |
