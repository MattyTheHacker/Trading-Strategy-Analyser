...
- **Everything §M26.5 owed is still owed.** The VWAP basis is unpinned, and every number here is off the raw spliced continuous series rather than per contract — §M26's first trap, that both σ and the basis step at every roll seam.
