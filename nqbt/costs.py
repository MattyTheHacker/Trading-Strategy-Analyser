...
class TradingCosts:
    ...
    commission_per_contract: float  # Round-turn dollars per contract, charged once per leg on exit.
    slippage_ticks: float  # Ticks of adverse fill, applied per stop or market fill and never to a limit.
